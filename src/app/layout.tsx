...
export const metadata: Metadata = {
  ...
  description:
    'A comprehensive collection of 33 developer tools for everyday tasks including converters, formatters, generators, and more.',
  keywords: [
    'developer tools',
    'base64 encoder',
    'json formatter',
  ...
  openGraph: {
    ...
    description:
      'A comprehensive collection of 33 developer tools for everyday tasks',
    siteName: 'Dev Tools',
  },
  twitter: {
