...
- 37 tool pages are exported statically from `src/lib/utils/tool-registry.ts`
...
- Text: counting, case conversion, placeholder generation, find/replace, text diff, Markdown editing, and resume/CV readability analysis
